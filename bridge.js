...
// bridge.js (Smart Cached + Mutual Disable + Auto Exit + Multi-Joint + Debug)
...
async function pollLivestream() {
  ...
  for (const lang of Object.keys(languages)) {
    ...
    /* 🔎 Discovery */
    if (lang === "joint") {
      // 🔥 ALWAYS search for joint (important fix)
  ...
  /* 🔥 Disable Joint if English + Mandarin both live */
  if (
    englishEverLive &&
    mandarinEverLive &&
    !streamEnded["joint"]
